...
<section className="content-section">
            <div className="container">
                <div className="text-content">
                    <p>
                        <b>We are delighted that you have shown interest in our website and
                        HiMMP. Data protection is of a particularly high priority for the
                        management of the Website himmp.net. The use of the Internet
                        pages of the Website himmp.net is possible without any indication of
                        ...
                        generally obtain consent from the data subject.</b>
                    </p>
                    <p>
                        ...
                        Website himmp.net. By means of this data protection declaration, we
                    ...
                    <p>
                        The controller has implemented numerous technical and organizational
                    ...
                    <h3>Definitions</h3>
                    <p>
                        The data protection declaration of the Website himmp.net is based on
                        ...
                        as well as our partners. To ensure this, we would like to first explain the
                        terminology used.
                    </p>
                    <p>
                    ...
                    <ul>
                        ...
                        <li>
                            <strong>Pseudonymisation</strong><br />
                        ...
                        <li>
                            <strong>Controller or controller responsible for the processing</strong><br />
                    ...
                    <p>
                        Prof. Dr. Dr. Jan-Peter Herbst<br />
                        University of Huddersfield<br />
                        Queensgate<br />
                        Huddersfield, West Yorkshire<br />
                        HD1 3DH<br />
                        United Kingdom<br />
                        Email: <a href="mailto:j.herbst@hud.ac.uk">j.herbst@hud.ac.uk</a><br />
                    ...
                    <p>
                        The website of the Website himmp.net collects a series of general data
                    ...
                    <p>
                        ...
                        the Website himmp.net analyzes anonymously collected data and
                        information statistically, with the aim of increasing the data protection
                        and data security of our website, and to ensure an optimal level of
                    ...
                    <p>
                        The website himmp.net contains information that enables a quick
                        electronic contact to us, as well as direct communication with us, which
                    ...
                    <ul>
                        <li>
                            <strong>Right of confirmation</strong><br />
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li>the recipients or categories of recipients to whom the
                                personal data have been or will be disclosed, in particular
                                recipients in third countries or international organisations;</li>
                                <li>where possible, the envisaged period for which the personal
                                ...
                                <li>the existence of the right to lodge a complaint with a
                                supervisory authority;</li>
                                <li>where the personal data are not collected from the data
                                subject, any available information as to their source;</li>
                                <li>the existence of automated decision-making, including
                                ...
                                consequences of such processing for the data subject.</li>
                            </ul>
                            ...
                            she may, at any time, contact the controller.</p>
                        </li>
                        <li>
                            ...
                            <p>If a data subject wishes to exercise this right to rectification, he or
                            she may, at any time, contact the controller.</p>
                        </li>
                        <li>
                            ...
                            <ul>
                                <li>The personal data are no longer necessary in relation to the
                                purposes for which they were collected or otherwise
                                processed.</li>
                                <li>The data subject withdraws consent to which the processing
                                ...
                                <li>The data subject objects to the processing pursuant to
                                ...
                                <li>The personal data have been collected in relation to the offer
                            ...
                            Website himmp.net, he or she may, at any time, contact the
                            controller. The controller will promptly ensure that the erasure
                            ...
                            processing is not required. The controller of the Website himmp.net
                        ...
                        <li>
                            ...
                            <ul>
                                <li>The accuracy of the personal data is contested by the data
                                subject, for a period enabling the controller to verify the
                                accuracy of the personal data.</li>
                                <li>The processing is unlawful and the data subject opposes the
                                erasure of the personal data and requests instead the
                                restriction of their use instead.</li>
                                <li>The controller no longer needs the personal data for the
                                purposes of the processing, but they are required by the data
                                subject for the establishment, exercise or defence of legal
                                claims.</li>
                                <li>The data subject has objected to processing pursuant to
                            ...
                            stored by the Website himmp.net, he or she may at any time
                            contact the controller. The controller of the Website himmp.net will
                        ...
                        <li>
                            ...
                            <p>In order to assert the right to data portability, the data subject may
                            at any time contact the controller of the Website himmp.net.</p>
                        </li>
                        <li>
                            ...
                            <p>The Website himmp.net shall no longer process the personal data
                            ...
                            <p>If the Website himmp.net processes personal data for direct
                            ...
                            Website himmp.net to the processing for direct marketing
                            purposes, the Website himmp.net will no longer process the
                            personal data for these purposes.</p>
                            
                            <p>In addition, the data subject has the right, on grounds relating to his
                            or her particular situation, to object to processing of personal data
                            concerning him or her by the Website himmp.net for scientific or
                            ...
                            contact the controller of the Website himmp.net. In addition, the
                        ...
                        <li>
                            ...
                            <p>If the decision (1) is necessary for entering into, or the performance
                            of, a contract between the data subject and a data controller, or (2)
                            it is based on the data subject's explicit consent, the Website
                            himmp.net shall implement suitable measures to safeguard the
                            ...
                            contact the controller of the Website himmp.net.</p>
                        </li>
                        <li>
                            ...
                            consent, he or she may, at any time, contact the controller of the
                            Website himmp.net.</p>
                        </li>
                    </ul>
                    ...
                    <p>
                        ...
                        case of inquiries concerning our products or services. If we are subject
                        to a legal obligation by which processing of personal data is required,
                        such as for the fulfillment of tax obligations, the processing is based on
                        Art. 6(1) lit. c GDPR.
                    </p>
                    <p>
                        ...
                        our premises and his name, age, health insurance data or other vital
                    ...
                    <p>
                        ...
                        our legitimate interest is to carry out our business in favor of the well-
                        being of all.
                    </p>
                    ...
                    <h3>12. Provision of personal data as statutory or contractual requirement; Requirement necessary to enter into a contract; Obligation of the data subject to provide the personal data; possible consequences of failure to provide such data</h3>
                    <p>
                    ...
                    <p>
                        ...
                        with personal data when we sign a contract with him or her. The non-
                        provision of the personal data would have the consequence that the
                    ...
                    <p>
                        ...
                        must contact the controller. He then clarifies to the data subject whether
                    ...
                    <p>
                        ...
                        of the <a href="https://dg-datenschutz.de/?lang=en" target="_blank"><b><u>German Association for Data Protection</u></b></a> that was developed in
                        cooperation with <a href="https://www.wbs-law.de/eng/practice-areas/internet-law/it-law/" target="_blank"><b><u>Privacy Lawyers</u></b></a> from WILDE BEUGER SOLMECKE,
                        Cologne.
                    </p>
                </div>
            </div>
