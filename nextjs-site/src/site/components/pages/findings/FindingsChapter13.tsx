 ...
 */
export const FindingsChapter13Headings: FindingsChapterHeading[] = [
  { id: "bridging-the-philosophical-divide", text: "Bridging the Philosophical Divide" },
  { id: "beyond-western-production-paradigms", text: "Beyond Western Production Paradigms" },
  { id: "the-enduring-fundamentals", text: "The Enduring Fundamentals" }
];
